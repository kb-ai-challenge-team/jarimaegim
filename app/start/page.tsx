...
export default function StartPage() {
  return <main id="main-content" className="simple-page start-page">
    <header className="simple-header"><Link className="brand" href="/"><span className="brand-mark" aria-hidden="true"></span>자리매김</Link></header>
    <section className="start-notice"><p className="eyebrow">시작하기 전에</p><h1>무엇을 저장하고,<br/>무엇을 결정하지 않는지 알려드릴게요.</h1><p className="page-lead">별도 계정 없이 바로 시작합니다. 입력한 조건과 생성 문서는 현재 브라우저의 익명 세션에서 최대 24시간 접근할 수 있으며, 결과는 창업과 금융 결정을 대신하지 않습니다.</p>
