...
export default function StartPage() {
  return <main id="main-content" className="simple-page start-page">
    <header className="simple-header"><Link className="brand" href="/"><span className="brand-mark" aria-hidden="true"></span>자리매김</Link><Link className="text-link" href="/auth">로그인</Link></header>
