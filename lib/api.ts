import type { AnalysisResult, Candidate, CaseInput, CaseRecord, ChatStreamHandlers, ChatToolActivity, Citation, CostPlan, DocumentRecord, FundingBandInput, FundingBandResult, KbProduct, Program, StatusResponse } from "./types";
